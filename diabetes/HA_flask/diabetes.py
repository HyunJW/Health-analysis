...
def main():
    return render_template('HA_flask/input.html')

@app.route('/result', methods=['POST'])
def result():
    model = load_model('C:/Health Analysis/neo_keras.h5')
    scaler = joblib.load('C:/Health Analysis/scaler.model')
    ...
    return render_template('HA_flask/result.html', prob=f'{100 * prob[0][0]:.2f}%', result=result,
